...
in tutto il mondo. Il potere \'e sempre stato in mano alla famiglia Agnelli, che a partire dal 1923 hanno guidato il club torinese ad un lungo
...
\begin{enumerate}
    \item Analisi dei Ricavi:\newline
        ...
        che l'Allianza Stadium ha una media spettatori simile a quella dell'Artemio Franchi di Firenze, palcoscenico piuttosto differente da 
    ...
    \item Analisi della liquidit\'a:\newline
        ...
        Per essere considerato efficace il Margine di Tesoreria e il relativo Indice di Liquidit\'a primaria devono essere rispettivamente positivo
        e maggiore di uno\footnote{Valter Cantino, Paola De Bernardi, Alain Devalle (2018) Sistemi di rilevazione e misurazione delle performance aziendali Torino: G. Giappichelli};
        in entrambi i casi questi requisiti non vengono soddisfatti. I dati peggiorano anche rispetto all'anno precedente
        questo a causa dell'acquisto, detto in precedenza, del calciatore Cristiano Ronaldo, il quale in Bilancio ha il suo peso con un 
        ...
        richieste i club vendono giocatori oppure dsi indebitano, andando a creare un vero e proprio circolo vizioso.
...
che nel 2011\footnote{Wikipedia: https://it.wikipedia.org/wiki/Nasser\_Al-Khela\%C3\%AFfi} acquista la maggioranza delle quote della societ\'a e da il via ad un periodo di spese folli per creare un vero e proprio impero.
...
\begin{enumerate}
    ...
    \item Analisi della liquidit\'a:\newline
       ...
       liquide e immediate, riesce comunque a tenere sotto controllo le passivit\'a a breve anche se ovviamente deve prestare attenzione.
    \item Analisi della solidit\'a:\newline
        \begin{equation}
...
\begin{enumerate}
    ...
    \item Analisi della solidit\'a:\newline
        ...
        la siciet\'a faccia uso quasi nella totalit\'a al capitale di debito.
    \item Analisi della Redditivit\'a:\newline
        \begin{equation}
...
\begin{enumerate}
    \item Analisi dei Ricavi:\newline
        \begin{figure}
            \centering
            \includegraphics[scale=.5]{img/CE_city.png}
    ...
    \item Analisi della liquidit\'a:\newline
        \begin{figure}
            \centering
            \includegraphics[scale=.5]{img/SP_city.png}
            \caption{Stato Patrimoniale Manchester City al 30 Giugno 2019}
            \label{sp_city}
        \end{figure}\newline
        \begin{equation}
                \text{Margine di Tesoreria} = 129.856.999-843.220.000 = \mathbf{-713.364.000\mbox{\euro}}
    ...
    \item Analisi della solidit\'a:\newline
        \begin{equation}
            \text{Grado di Indipendenza Finanziaria} = \frac{1.316.346.000}{756.721.000} = \mathbf{9,7\%}
        \label{eqn: indeb_barca}
        \end{equation}
        \begin{equation}
            \text{Margine di Struttura} = 132.607.000-747.979.000 = \mathbf{-615.372.000\mbox{\euro}}
