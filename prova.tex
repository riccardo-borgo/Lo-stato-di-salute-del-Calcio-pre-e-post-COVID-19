...
ad un giudizio ponderato e corretto. Il periodo di monitoraggio si basa sui 2 esercizi precedenti a quello preso in considerazione e al termine
dell'analisi non si deve aver infranto nessuno dei punti presenti all'Articolo 62 parte 3, che comprende nella sua complessit\'a anche la 
\emph{Break-Even Rule}.
\end{interlinea}
\end{document}
