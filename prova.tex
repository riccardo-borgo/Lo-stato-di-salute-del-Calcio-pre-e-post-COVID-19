...
ha un storia simile a quella del Man City, dove grazie agli investimenti folli dei proprietari quatarioti sono riusciti a garantirsi un posto 
"tra i grandi d'Europa". La situazione anche in questo caso \'e molto simile a quella precedente, dove grazie a rigonfiamenti in bilancio
sopratutto alla voce delle sponsorizzazioni, \'e stato possibile acquistare e offrire ingaggi esorbitanti ai nuovi acquisti del club.
...
Le punizioni sono state pressoch\'e identiche a quelle indirizzate alla squadra inglese, con limiti per il numero di giocatori iscrivibili al 
campionato e multe in denaro. Il problema in questo caso sorge nel momento in cui la societ\'a, terminata la validit\'a delle "punizioni"
...
due tra i milgiori calciatori in prospettiva del panorama calcistico, Neymar e Mbappe, per una spesa totale che si \'e attestata intorno ai 367 
...
limite della legalit\'a e in secondo luogo ad escamotage che la UEFA in primis ha permesso. Nel caso del calciatore Kylian Mbappe, infatti,
\'e stato acquistato con la formula del prestito con obbligo di riscatto (fissato a 147 milioni circa) in caso di salvezza del PSG in campionato,
